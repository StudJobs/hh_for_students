// Package metrics — Prometheus-инструментация Users-сервиса.
// См. Search/internal/metrics/metrics.go для детальной документации шаблона.
package metrics
